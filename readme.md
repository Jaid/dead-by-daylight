...
```bash
npm install --save dead-by-daylight@^1.17.3
```
...
```bash
yarn add dead-by-daylight@^1.17.3
```
...
```bash
npm install --save @jaid/dead-by-daylight@^1.17.3
```
