...
```bash
npm install --save dead-by-daylight@^1.18.0
```
...
```bash
yarn add dead-by-daylight@^1.18.0
```
...
```bash
npm install --save @jaid/dead-by-daylight@^1.18.0
```
