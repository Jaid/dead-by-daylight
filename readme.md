...
```bash
npm install --save dead-by-daylight@^1.16.1
```
...
```bash
yarn add dead-by-daylight@^1.16.1
```
...
```bash
npm install --save @jaid/dead-by-daylight@^1.16.1
```
